...
## Описание
Новая система формирования команд для марафонов/хаккатонов и поиска участников по модели рекрутинговых платформ (пример hh.ru), где команда - работодатель, а участник марафона - соискатель.

## Документы
- [Дизайн документ](design%20document.md)
